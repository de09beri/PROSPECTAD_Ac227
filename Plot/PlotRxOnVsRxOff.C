...
cout<<"ENERGY"<<endl;
	...
	cRnPoEn->cd(1);		
	gPad->SetGrid();
	hPoEn_On->GetYaxis()->SetRangeUser(0,70);
...
cout<<"DZ"<<endl;
	...
	cRnPoDz->cd(2);
	gPad->SetGrid();
	hRnPoDz_Sub->GetYaxis()->SetRangeUser(-1.2,1.2);
	hRnPoDz_Sub->GetYaxis()->SetTitle(yTitle);
...
cout<<"RATE"<<endl;	
	...
	cRate->cd(2);
	gPad->SetGrid();
	hRate_Sub->GetYaxis()->SetRangeUser(-0.1,0.1);
	hRate_Sub->GetYaxis()->SetTitle(yTitle);
...
cout<<"ENERGY MEAN"<<endl;
	...
	cPoEnMean->cd(2);
	gPad->SetGrid();
	hPoEnMean_Sub->GetYaxis()->SetRangeUser(-0.01,0.01);
	hPoEnMean_Sub->GetYaxis()->SetTitle(yTitle);
...
cout<<"ENERGY SIGMA"<<endl;
	...
	cPoEnSigma->cd(1);
	gPad->SetGrid();
	hPoEnSigma_On->GetYaxis()->SetRangeUser(40,58);
	...
	cPoEnSigma->cd(2);
	gPad->SetGrid();
	hPoEnSigma_Sub->GetYaxis()->SetRangeUser(-0.1,0.1);
	hPoEnSigma_Sub->GetYaxis()->SetTitle(yTitle);
...
cout<<"DZ MEAN"<<endl;
	...
	cRnPoDzMean->cd(1);
	gPad->SetGrid();
	hRnPoDzMean_On->GetYaxis()->SetRangeUser(-3.5,3.5);
	...
	cRnPoDzMean->cd(2);
	gPad->SetGrid();
	hRnPoDzMean_Sub->GetYaxis()->SetRangeUser(-30,30);
	hRnPoDzMean_Sub->GetYaxis()->SetTitle(yTitle);
...
cout<<"DZ SIGMA"<<endl;
	...
	cRnPoDzSigma->cd(2);
	gPad->SetGrid();
	hRnPoDzSigma_Sub->GetYaxis()->SetRangeUser(-0.1,0.1);
	hRnPoDzSigma_Sub->GetYaxis()->SetTitle(yTitle);
