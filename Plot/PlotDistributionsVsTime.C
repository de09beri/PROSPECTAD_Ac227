...
cout<<"Loading hists"<<endl;
	...
	//----------------------------------------------------------
	TF1 *fRnPSDGaus0 = new TF1("fRnPSDGaus0","gaus",EnMin,EnMax);
	TF1 *fRnPSDGaus1 = new TF1("fRnPSDGaus1","gaus",EnMin,EnMax);
	...
	cRnPSD->SaveAs(Form("%s/RnPSD_TimeBin%i.png",gSystem->Getenv("AD_AC227_PLOTS"),timeBin));
	...
	cPoPSD->SaveAs(Form("%s/PoPSD_TimeBin%i.png",gSystem->Getenv("AD_AC227_PLOTS"),timeBin));
	...
	cRnEn->SaveAs(Form("%s/RnEn_TimeBin%i.png",gSystem->Getenv("AD_AC227_PLOTS"),timeBin));
	...
	cPoEn->SaveAs(Form("%s/PoEn_TimeBin%i.png",gSystem->Getenv("AD_AC227_PLOTS"),timeBin));
	...
	cRnPos->SaveAs(Form("%s/RnPos_TimeBin%i.png",gSystem->Getenv("AD_AC227_PLOTS"),timeBin));
	...
	cPoPos->SaveAs(Form("%s/PoPos_TimeBin%i.png",gSystem->Getenv("AD_AC227_PLOTS"),timeBin));
